def encode_intensity(intensity_str):
    """
    Encodes craving intensity as an ordinal integer.
    0 = Unknown/None, 1 = Low, 2 = Medium, 3 = High ("very high" is capped at 3).
    """
    ...
    return mapping.get(intensity_str.lower(), 0)

def encode_time_of_day(time_str):
    """
    Encodes time of day as an ordinal integer.
    0 = Unknown, 1 = Morning, 2 = Afternoon, 3 = Evening, 4 = Night.
    """
    if not time_str:
        return 0
